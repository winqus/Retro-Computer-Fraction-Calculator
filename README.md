...
The task of this project was to use a compiled third-party unmanaged C++ DLL that sums fractions and create a front-end app for it in a different programming language.
